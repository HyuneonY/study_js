...
// [추가 요구사항]
// 1. modelName, modelTear, price, type을 가져오는 메서드
// 2. modelName, modelTear, price, type을 세팅하는 메서드
...
class Car {
    ...
    set modelYear(value) {
        ...
        if (value.length !== 4) {
            ...
            console.log('[오류] 입력된 모델명이 숫자가 아닙니다!');
            return;
        }
    ...
    set price(value) {
        if (typeof value != 'number') {
            console.log('[오류] 가격으로이 입력된 값이 숫자가 아닙니다. 확인해주세요!');
            return;
